...
/**
 * Test fuer: HelpIntentHandler
 * @author Anonymous Student
 */
public class HelpIntentHandlerTest extends TestCase {
    ...
    public void testCanHandle() {
        HandlerInput input = getHandlerInput("AMAZON.HelpIntent", "UserA");
    ...
    public void testHandle() {
        ...
        String want = "Hi, ich bin Remindme. Ich helfe dir deine Ereignisse zu notieren und erinnere dich rechtzeitig an diese.";
        String have = getSpeechValue(new HelpIntentHandler().handle(input));
